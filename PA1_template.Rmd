...
The `r maxInterval` interval has the highest average number of steps.
...
In the data set with missing values, the mean was `r meanSteps` and is still `r meanSteps2`. The median number of steps taken was `r medianSteps` and is now `r medianSteps2`.  Not much has changed.
